...
\begin{figure}[h]
\centering
\includegraphics[width=14cm]{Images/organigramme_hourtin2.png} 
...
\includegraphics[width=6cm]{Images/profondeur_hourtin2.png} 
...
%\begin{figure}
%\begin{minipage}{0.4\textwidth}
%\includegraphics[width=5cm]{Images/profondeur_hourtin2.png} 
%\caption{Carte bathymétrique du lac de Carcans-Hourtin (université de bordeaux), la profondeur est inférieure
%à 2m sur la moitié est du lac (limite 2 m en vert)\label{carte_profondeur}}
%\end{minipage}
%\hfill
%\begin{minipage}{0.4\textwidth}
...
\begin{figure}
\begin{minipage}{0.4\textwidth}
\includegraphics[width=7cm]{Images/spot/1000013821.jpg} 
\caption{Zone de pratique}
\end{minipage}
\hfill
\begin{minipage}{0.4\textwidth}
\includegraphics[width=5cm]{Images/spot/1000013820.jpg} 
...
\begin{figure}[h]
\begin{minipage}{0.4\textwidth}
\includegraphics[width=7cm]{Images/matos2.jpg} 
\caption{Ailes à boudins et ailes hybrides\label{ailes}}
\end{minipage}
\hfill
\begin{minipage}{0.4\textwidth}
\includegraphics[width=3cm]{Images/planches1.jpg} 
...
un autre stagiaire est sous son  vent. Le respect d'une distance minimale est très important pour la sécurité.
%\begin{figure}
...
De plus, les moniteurs de voile et de surf pourront se faire une idée des avantages et
...
au kitesurf. Une deuxième séance pour un public plus avancé est 
aussi présentée succintement.
...
\includegraphics[width=12cm]{Images/projet_planning2.jpg} 
...
\begin{figure}
\centering
\includegraphics[width=5cm]{Images/bateaux.jpg} 
...
Aurélien est déja un kitesurfeur confirmé, il a pu rider avec une 13 $m^3$, 
remonter au vent et effectuer des petits sauts
Rémi est un moniteur de surf et commence à rider et remonter au vent.
